...
Originally appeared as part of the `nakamura-gebiet.de/scripts/` repository.

Retrieved from the depths of the [Wayback Machine](https://web.archive.org/web/20090414130521/http://www.nakamura-gebiet.de:80/scripts/processes.py).

Depends on [cpulimit](https://cpulimit.sourceforge.net/), the original software
appears to be a dead project but a [fork exists](https://github.com/torden/cpulimit/).
...
def printXml(pid):
    ...
    _procData(pid)=[[0]-State,_[1]-VmSize,_[2]-VmLck,_[3]-VmRSS,_[4]-VmLib,_[5]-priority(nice),_[6]-command,_[(***)optional:_[7]-cpu_usage|0]-State, [1]-VmSize, [2]-VmLck, [3]-VmRSS, [4]-VmLib, [5]-priority(nice), [6]-command, [(***)optional: [7]-cpu usage]] """
